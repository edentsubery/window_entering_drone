...
#
# image1, windows, is_within_rectangles=detect_and_check_rectangles(image, result[0].boxes.xywh)
# #image1 is the marked image with the results filtered by rectangle condition
# #windows are coordinate of the windows
# #is_within_rectangles is a bool array, in each index true/false if result[index] is recognizes as a rectanle
# cv2.imwrite('Modified Image.png', image1)
